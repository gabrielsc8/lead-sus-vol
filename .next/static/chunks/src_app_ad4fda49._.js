...
"[project]/src/app/admin/add/AdminForm.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AdminForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setMessage(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/admins', {
                name,
                email,
                password,
                role: 'admin'
...
_s(AdminForm, "KzTGthhs27A0pS8EoOb5MQ3R3Vw=");
_c = AdminForm;
var _c;
...
//# sourceMappingURL=src_app_ad4fda49._.js.map