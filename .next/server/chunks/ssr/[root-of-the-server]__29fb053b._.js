...
function Etapa1({ form, handleChange, onNext, onBack, tipoVoluntario, isSubmitting }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (form.estado) {
            const estadoSelecionado = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$estados$2d$cidades$2e$json__$28$json$29$__["default"].estados.find((e)=>e.sigla === form.estado);
        ...
        if (type === "checkbox") {
            setForm((prev)=>{
                ...
                if (checked) {
                    ...
                    return {
                        ...prev,
                        ministerio: ministeriosAtuais.filter((item)=>item !== value)
                    };
                }
            });
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__29fb053b._.js.map